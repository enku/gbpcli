...
build = "query ($name: String!, $number: Int!) {\n  build(name: $name, number: $number) {\n    name\n    number\n    keep\n    published\n    notes\n    submitted\n    completed\n    packagesBuilt {\n      cpv\n    }\n  }\n}\n"
builds = "query ($name: String!) {\n  builds(name: $name) {\n    name\n    number\n    submitted\n    completed\n    published\n    notes\n    keep\n  }\n}\n"
builds_with_packages = "query ($name: String!) {\n  builds(name: $name) {\n    name\n    number\n    submitted\n    completed\n    published\n    notes\n    keep\n    packagesBuilt {\n      cpv\n    }\n  }\n}\n"
create_note = "mutation ($name: String!, $number: Int!, $note: String) {\n  createNote(name: $name, number: $number, note: $note) {\n    notes\n  }\n}\n"
diff = "query ($left: BuildInput!, $right: BuildInput!) {\n  diff(left: $left, right: $right) {\n    left {\n      name\n      number\n      submitted\n    }\n    right {\n      name\n      number\n      submitted\n    }\n    items {\n      item\n      status\n    }\n  }\n}\n"
keep_build = "mutation ($name: String!, $number: Int!) {\n  keepBuild(name: $name, number: $number) {\n    keep\n  }\n}\n"
latest = "query ($name: String!) {\n  latest(name: $name) {\n    number\n  }\n}\n"
logs = "query ($name: String!, $number: Int!) {\n  build(name: $name, number: $number) {\n    logs\n  }\n}\n"
machines = "query {\n  machines {\n    name\n    buildCount\n  }\n}\n"
packages = "query ($name: String!, $number: Int!) {\n  build(name: $name, number: $number) {\n    packages\n  }\n}\n"
publish = "mutation ($name: String!, $number: Int!) {\n  publish(name: $name, number: $number) {\n    publishedBuild {\n      number\n    }\n  }\n}\n"
pull = "mutation ($name: String!, $number: Int!) {\n  pull(name: $name, number: $number) {\n    buildCount\n  }\n}\n"
release_build = "mutation ($name: String!, $number: Int!) {\n  releaseBuild(name: $name, number: $number) {\n    keep\n  }\n}\n"
